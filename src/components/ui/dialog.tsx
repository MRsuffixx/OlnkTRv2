  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed top-1/2 left-1/2 z-50 w-[min(92vw,30rem)] -translate-x-1/2 -translate-y-1/2 rounded-lg border border-border bg-surface-raised p-5 text-foreground shadow-floating outline-none data-[state=open]:animate-popover",
          className,
        )}
        {...props}
      >
